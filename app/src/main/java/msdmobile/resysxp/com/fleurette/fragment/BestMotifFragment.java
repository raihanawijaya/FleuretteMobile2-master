...
import msdmobile.resysxp.com.fleurette.adapter.BestMotifAdapter;
 ...
 */
public class BestMotifFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView rvList;
    private BestMotifAdapter adapter;
    private List<GetViewBestMotif> listData = new ArrayList<>();
    private SharedPreference sharedPreference;
    private String storeCode, date,todayQty, todayNett, mtdQty, mtdNett;

    public BestMotifFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new BestMotifAdapter(getContext());
    ...
    private void getDataTransaction(String storeCode, String date) {
        ...
        try {
            Call<GetViewBestMotifResponse> call = RetrofitServices.sendDataRequest().GetViewBestMotif(storeCode, date);
            if (call != null) {
                call.enqueue(new Callback<GetViewBestMotifResponse>() {
                    @Override
                    public void onResponse(Call<GetViewBestMotifResponse> call, Response<GetViewBestMotifResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            GetViewBestMotif dataMtdTransactionModel = null;
                            if (!error) {
                                listData = response.body().GetViewBestMotif();
                    ...
                    @Override
                    public void onFailure(Call<GetViewBestMotifResponse> call, Throwable t) {
                        swipeRefreshLayout.setRefreshing(false);
