...
public class BestDiscCodeAdapter extends RecyclerView.Adapter<BestDiscCodeAdapter.ViewHolder>{
    private Context context;
    private List<GetViewBestDiscCode> listData;

    public BestDiscCodeAdapter(Context context) {
        this.context = context;
        listData = new ArrayList<>();
    }

    public void setData(List<GetViewBestDiscCode> listData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.best_disc_code_items,parent,false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        final GetViewBestDiscCode dataModel = listData.get(position);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tvDiscCode, tvNett, tvNettPct, tvQty,tvAvgPrice;
