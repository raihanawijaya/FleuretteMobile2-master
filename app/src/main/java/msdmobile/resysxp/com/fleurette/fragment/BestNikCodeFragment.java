...
import msdmobile.resysxp.com.fleurette.adapter.BestNikCodeAdapter;
 ...
 */
public class BestNikCodeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout swipeRefreshLayout;
    private RecyclerView rvList;
    private BestNikCodeAdapter adapter;
    private List<GetViewBestNikCode> listData = new ArrayList<>();
    private SharedPreference sharedPreference;
    private String storeCode, date,todayQty, todayNett, mtdQty, mtdNett;

    public BestNikCodeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_best_nik_code, container, false);
        swipeRefreshLayout = v.findViewById(R.id.swipe);
        rvList = v.findViewById(R.id.rv_list);

        adapter = new BestNikCodeAdapter(getContext());
    ...
    private void getDataTransaction(String storeCode, String date) {
        ...
        try {
            Call<GetViewBestNikCodeResponse> call = RetrofitServices.sendDataRequest().GetViewBestNikCode(storeCode, date);
            if (call != null) {
                call.enqueue(new Callback<GetViewBestNikCodeResponse>() {
                    @Override
                    public void onResponse(Call<GetViewBestNikCodeResponse> call, Response<GetViewBestNikCodeResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            GetViewBestNikCode dataMtdTransactionModel = null;
                            if (!error) {
                                listData = response.body().GetViewBestNikCode();
                    ...
                    @Override
                    public void onFailure(Call<GetViewBestNikCodeResponse> call, Throwable t) {
                        swipeRefreshLayout.setRefreshing(false);
